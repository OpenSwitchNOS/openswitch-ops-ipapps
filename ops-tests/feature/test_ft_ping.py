...
def ping_network_unreachable(sw2):
    ...
    out = sw2("ping 10.11.1.1 -c 1", shell="bash")
...
def ping_destination_unreachable(sw2):
    ...
    out = sw2.libs.vtysh.ping_repetitions('10.0.10.5', 1)

    assert out['packet_loss'] == 100


def ping_unknown_host(sw2):
    # Ping unknown host
    print("Test ping unknown host case")
    out = sw2.libs.vtysh.ping_repetitions('asdfrgqweewwe', 1)
...
def ping6_network_unreachable(sw2):
    ...
    out = sw2("ping6 1050::1 -c 1", shell="bash")
...
def ping6_unknown_host(sw2):
    # Ping6 unknown host
    print("Test ping unknown host case")
    out = sw2.libs.vtysh.ping6_repetitions('asdfrgqweewwe', 1)
