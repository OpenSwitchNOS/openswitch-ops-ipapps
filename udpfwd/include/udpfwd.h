...
#define DHCP_MSGTYPE         ((unsigned char)  53)
#define DHCP_SERVER_ID       ((unsigned char)  54)
#define PAD                  ((unsigned char)   0)
#define END                  ((unsigned char) 255)
#define OPT_OVERLOAD         ((unsigned char)  52)
#define NO_RELAY                 3
...
typedef struct UDPF_CTRL_CB
{
    ...
    sem_t waitSem;
    struct shash intfHashTable;
    struct cmap serverHashMap;
    bool dhcp_relay_enable;
} UDPFWD_CTRL_CB;
