...
{
    uint32_t     dhcp_client_drops; /* number of dropped client requests */
    uint32_t     dhcp_client_valids; /* number of valid client requests */
    uint32_t     dhcp_serv_drops; /* number of dropped server responses */
    uint32_t     dhcp_serv_valids; /* number of valid server responses */
    uint32_t     dhcp_client_drops_with_option82; /* number of dropped client requests with option 82 */
    uint32_t     dhcp_client_valids_with_option82; /* number of valid client requests with option 82 */
    uint32_t     dhcp_serv_drops_with_option82; /* number of dropped server responses with option 82 */
    uint32_t     dhcp_serv_valids_with_option82; /* number of valid server responses with option 82 */
...
typedef struct UDPFWD_INTERFACE_NODE_T
{
  ...
  struct DHCP_RELAY_PKT_COUNTER dhcp_relay_pkt_counters; /* Counts of dhcp-relay statistics */
