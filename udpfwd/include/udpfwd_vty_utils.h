...
find_udpfwd_server_ip (char **, int8_t,
                       udpfwd_server *);
extern bool
is_helper_address_count_max(const char *);
extern bool
is_server_address_count_max (const char *);
...
extern void
udpfwd_dhcpserverupdate (const struct
                         ovsrec_dhcp_relay *,
                         bool , udpfwd_server *, udpfwd_feature);
extern void
udpfwd_udpserverupdate (const struct
