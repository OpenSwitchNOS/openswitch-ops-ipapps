...
port_refresh_dhcp_relay_stats(struct ovsdb_idl *idl)
{
    ...
    SHASH_FOR_EACH_SAFE(node, next, &udpfwd_ctrl_cb_p->intfHashTable)
    {
        ...
        if (found)
        {
            ...
            keys[VALID_V4CLIENT_REQUESTS] = PORT_DHCP_RELAY_STATISTICS_MAP_VALID_V4CLIENT_REQUESTS;
            int_values[VALID_V4CLIENT_REQUESTS] = UDPF_DHCPR_CLIENT_SENT(intfNode);
            keys[DROPPED_V4CLIENT_REQUESTS] = PORT_DHCP_RELAY_STATISTICS_MAP_DROPPED_V4CLIENT_REQUESTS;
            int_values[DROPPED_V4CLIENT_REQUESTS] = UDPF_DHCPR_CLIENT_DROPS(intfNode);
            keys[VALID_V4SERVER_RESPONSES] = PORT_DHCP_RELAY_STATISTICS_MAP_VALID_V4SERVER_RESPONSES;
            int_values[VALID_V4SERVER_RESPONSES] = UDPF_DHCPR_SERVER_SENT(intfNode);
            keys[DROPPED_V4SERVER_RESPONSES] = PORT_DHCP_RELAY_STATISTICS_MAP_DROPPED_V4SERVER_RESPONSES;
            int_values[DROPPED_V4SERVER_RESPONSES] = UDPF_DHCPR_SERVER_DROPS(intfNode);
            keys[VALID_V4CLIENT_REQUESTS_WITH_OPTION82] = PORT_DHCP_RELAY_STATISTICS_MAP_VALID_V4CLIENT_REQUESTS_WITH_OPTION82;
            int_values[VALID_V4CLIENT_REQUESTS_WITH_OPTION82] = UDPF_DHCPR_CLIENT_SENT_WITH_OPTION82(intfNode);
            keys[DROPPED_V4CLIENT_REQUESTS_WITH_OPTION82] = PORT_DHCP_RELAY_STATISTICS_MAP_DROPPED_V4CLIENT_REQUESTS_WITH_OPTION82;
            int_values[DROPPED_V4CLIENT_REQUESTS_WITH_OPTION82] = UDPF_DHCPR_CLIENT_DROPS_WITH_OPTION82(intfNode);
            keys[VALID_V4SERVER_RESPONSES_WITH_OPTION82] = PORT_DHCP_RELAY_STATISTICS_MAP_VALID_V4SERVER_RESPONSES_WITH_OPTION82;
            int_values[VALID_V4SERVER_RESPONSES_WITH_OPTION82] = UDPF_DHCPR_SERVER_SENT_WITH_OPTION82(intfNode);
            keys[DROPPED_V4SERVER_RESPONSES_WITH_OPTION82] = PORT_DHCP_RELAY_STATISTICS_MAP_DROPPED_V4SERVER_RESPONSES_WITH_OPTION82;
            int_values[DROPPED_V4SERVER_RESPONSES_WITH_OPTION82] = UDPF_DHCPR_SERVER_DROPS_WITH_OPTION82(intfNode);

            ovsrec_port_set_dhcp_relay_statistics(rec->port, keys, int_values,
