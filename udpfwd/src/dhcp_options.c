 ...
 *
 * Returns:    UNCHANGED - if the packet is not processed
 *             VALID_INCREMENT - if the packet is valid
 *             DROP_INCREMENT - if any failures
 */
OPTION82_RESUL_t process_dhcp_relay_option82_message(void *pkt, DHCP_OPTION_82_OPTIONS *pkt_info,
