...
DHCP_OPTION_82_COUNTERS dhcp_option_82_counters;
                               ...
                               DHCP_RELAY_OPTION82_REMOTE_ID remote_id)
{
    ...
    /* FIXME : code related to circuit id and vxlan tunnels, not sure to add or not */
...
bool dhcpr_check_and_process_option82_message(void *pkt,
                                             DHCP_OPTION_82_OPTIONS *pkt_info,
                                             uint8_t relay_type, int32_t *new_size)
{
...
/* length needs to be returned from here, new dhcp packet length.
 Add debugs to print value of length */
    *new_size = length;
#if 0
   ...
   /* TODO: update value of size here and return */
