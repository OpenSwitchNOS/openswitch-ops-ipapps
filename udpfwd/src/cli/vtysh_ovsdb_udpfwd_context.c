...
/*-----------------------------------------------------------------------------
| Function : vtysh_init_udpfwd_context_clients
| Responsibility : registers the client callbacks for UDP Forwarder context
| Return : On success, returns e_vtysh_ok. On failure, returns erro_no.
-----------------------------------------------------------------------------*/
int
vtysh_init_udpfwd_context_clients (void)
{
    vtysh_context_client client;
    vtysh_ret_val retval = e_vtysh_error;

    client.p_client_name = udp_forwarder_context_client_name;
    client.client_id = e_vtysh_udp_forwarder_context_config;
    client.p_callback = &vtysh_udp_forwarder_context_clientcallback;
    retval = vtysh_context_addclient(e_vtysh_udp_forwarder_context,
