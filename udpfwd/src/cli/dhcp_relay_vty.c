...
print_relay_statistics(void)
{
    ...
    uint32_t index;
    UDPF_PKT_COUNTER udp_counters;
    memset(&udp_counters, 0, sizeof(UDPF_PKT_COUNTER));
    udp_counters.dhcp_client_valids = 0;
    udp_counters.dhcp_client_drops = 0;
    udp_counters.dhcp_serv_drops = 0;
    udp_counters.dhcp_serv_valids = 0;
    udp_counters.dhcp_client_drops_with_option82 = 0;
    udp_counters.dhcp_client_valids_with_option82 = 0;
    udp_counters.dhcp_serv_drops_with_option82 = 0;
    udp_counters.dhcp_serv_valids_with_option82 = 0;
