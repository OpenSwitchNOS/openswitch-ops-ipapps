...
print_relay_statistics(void)
{
    ...
    dhcp_relay_pkt_counters.dhcp_client_valids = 0;
    dhcp_relay_pkt_counters.dhcp_client_drops = 0;
    dhcp_relay_pkt_counters.dhcp_serv_drops = 0;
    dhcp_relay_pkt_counters.dhcp_serv_valids = 0;
    dhcp_relay_pkt_counters.dhcp_client_drops_with_option82 = 0;
    dhcp_relay_pkt_counters.dhcp_client_valids_with_option82 = 0;
    dhcp_relay_pkt_counters.dhcp_serv_drops_with_option82 = 0;
    dhcp_relay_pkt_counters.dhcp_serv_valids_with_option82 = 0;
    ...
    vty_out(vty, "  %-10d %-10d %-10d %-10d%s",
            ...
            dhcp_relay_pkt_counters.dhcp_client_drops,
            dhcp_relay_pkt_counters.dhcp_serv_valids,
            dhcp_relay_pkt_counters.dhcp_serv_drops, VTY_NEWLINE);
    ...
    vty_out(vty, "  %-10d %-10d %-10d %-10d%s",
            ...
            dhcp_relay_pkt_counters.dhcp_client_drops_with_option82,
            dhcp_relay_pkt_counters.dhcp_serv_valids_with_option82,
            dhcp_relay_pkt_counters.dhcp_serv_drops_with_option82, VTY_NEWLINE);
