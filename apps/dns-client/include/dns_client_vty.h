...
"List of domains to which dns request is sent to complete unqualified host names\n"
...
{
    char hostname[MAX_HOST_NAME_LEN]; /* host name of the host */
