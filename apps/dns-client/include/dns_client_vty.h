...
typedef struct dnsHost_t
{
    ...
    char hostIpv4[MAX_HOST_ADDR_LEN]; /* host IPv4 address */
    char hostIpv6[MAX_HOST_ADDR_LEN]; /* host IPv6 address */
} dnsHost;

/* function prototypes */
extern int8_t
dnsclient_globalconfig(const char *);
extern int8_t
dnsclient_domain_nameconfig (bool , const char **);
extern bool
set_dnsclient_fields (const struct ovsrec_dns_client *,
                      bool, char * ,DNS_CLIENT_FIELDS);
extern int8_t
dnsclient_domain_listconfig (bool , const char **);
extern int8_t
dnsclient_server_addressconfig (bool , const char **);
extern bool
max_host_reached (const struct ovsrec_dns_client * , char *);
extern int8_t
dnsclient_host_config (bool , const char **);
extern int8_t
