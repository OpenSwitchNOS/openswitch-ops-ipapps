...
extern struct cmd_element cli_traceroute_cmd;
extern struct cmd_element cli_traceroute6_cmd;
extern struct cmd_element cli_traceroute_ipoption_cmd;
extern bool get_netns_from_vrf (const char *val, char* vrf_n);
