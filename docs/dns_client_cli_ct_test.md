...
### Objective
To verify enablement/disablement of the DNS client functionality, configure DNS client related configurations and verify the negative scenarios as well.
