...
### Test result criteria
#### Test pass criteria
Verify that the dhcp-relay option 82 with replace policy, mac remote ID and validation enable state are reflected in the `show dhcp-relay` command.
#### Test fail criteria
Verify that the dhcp-relay option 82 with replace policy, mac remote ID and validation enable state are not reflected in the `show dhcp-relay` command.
...
### Test result criteria
#### Test pass criteria
Verify that the dhcp-relay option 82 with replace policy, ip remote ID and validation enable state are reflected in the `show dhcp-relay` command.
#### Test fail criteria
Verify that the dhcp-relay option 82 with replace policy, ip remote ID and validation enable state are not reflected in the `show dhcp-relay` command.
...
### Test result criteria
#### Test pass criteria
Verify that the dhcp-relay option 82 with drop policy and mac remote ID are reflected in the `show dhcp-relay` command.
#### Test fail criteria
Verify that the dhcp-relay option 82 with drop policy and mac remote ID are not reflected in the `show dhcp-relay` command.
...
### Test result criteria
#### Test pass criteria
Verify that the dhcp-relay option 82 with drop policy, mac remote ID and validation enable state are reflected in the `show dhcp-relay` command.
#### Test fail criteria
Verify that the dhcp-relay option 82 with drop policy, mac remote ID and validation enable state are not reflected in the `show dhcp-relay` command.
...
### Test result criteria
#### Test pass criteria
Verify that the dhcp-relay option 82 with drop policy and ip remote ID are reflected in the `show dhcp-relay` command.
#### Test fail criteria
Verify that the dhcp-relay option 82 with drop policy and ip remote ID are not reflected in the `show dhcp-relay` command.
...
### Test result criteria
#### Test pass criteria
Verify that the dhcp-relay option 82 with drop policy, ip remote ID and validation enable state are reflected in the `show dhcp-relay` command.
#### Test fail criteria
Verify that the dhcp-relay option 82 with drop policy, ip remote ID and validation enable state are not reflected in the `show dhcp-relay` command.
