...
- [Verify relay destination address configuration](#verify-relay-destination-address-configuration)
    ...
    - [Verify the multiple helper-address configuration on a single interface](#verify-the-multiple-helper-address-configuration-on-a-single-interface)
...
### Description
Enable the dhcp-relay on dut01 using the command `dhcp-relay`.
...
### Description
Disable the dhcp-relay on dut01 using the command `no dhcp-relay`.
### Test result criteria
#### Test pass criteria
...
### Description
Verify the dhcp-relay configuration status using the command `show running-configuration`.
### Test result criteria
#### Test pass criteria
...
### Description
Verify the dhcp-relay status using the command `show dhcp-relay`.
### Test result criteria
#### Test pass criteria
...
### Description
Verify the helper-address configuration with unicast server IP on an intrerface.
### Test result criteria
#### Test pass criteria
The user is able to configure the helper-address with unicast server IP on an interface.
#### Test fail criteria
The user is unable to configure the helper-address with unicast server IP on an interface.

### Verify the helper-address configuration for multicast server IP
### Description
Verify the helper-address configuration with multicast server IP on an intrerface.
### Test result criteria
#### Test pass criteria
The user is unable to configure the helper-address, an error is displayed on the console.
#### Test fail criteria
The user is able to configure the helper-address with multicast server IP on an interface.

### Verify the helper-address configuration for broadcast server IP
### Description
Verify the helper-address configuration with broadcast server IP on an intrerface.
### Test result criteria
#### Test pass criteria
The user is unable to configure the helper-address, and an error is displayed on the console.
#### Test fail criteria
The user is able to configure the helper-address with broadcast server IP on an interface.
...
### Verify the multiple helper-address configuration on a single interface
### Description
Verify the multiple helper-address on the same interface of dut01.
### Test result criteria
#### Test pass criteria
The user is able to configure the multiple helper-address on a single interface.
#### Test fail criteria
The user is unable to configure the multiple helper-address on a single interface.
...
### Test result criteria
#### Test pass criteria
The user is able to configure the single helper-address on different interfaces.
#### Test fail criteria
The user is unable to configure the single helper-address on different interfaces.
...
### Test result criteria
#### Test pass criteria
The user is able to configure a maximum of 16 helper-address on a single interface.
#### Test fail criteria
The user is unable to configure a maximum of 16 helper-address on a single interface.
...
### Test result criteria
#### Test pass criteria
The user is unable to configure same helper-address on same interface multiple times.
#### Test fail criteria
The user is able to configure same helper-address on same interface multiple times.

### Verify the helper-address status
### Description
Verify the helper-address status on an interface using the command `show ip helper-address`.
### Test result criteria
#### Test pass criteria
...
### Description
Verify the helper-address status on the specified interface using the command `show ip helper-address interface IFNAME`.
### Test result criteria
#### Test pass criteria
...
### Description
Verify the helper-address configuration status using the command `show running-configuration`.
### Test result criteria
#### Test pass criteria
The user verifies the current helper-address configuration status is reflected in show command.
#### Test fail criteria
The user verifies the current helper-address configuration status is not reflected in show command.

### Verify the helper-address configuration status on the specified interface in show-running
### Description
Verify the helper-address configuration status on the specified interface using the command `show running-configuration interface IFNAME`.
### Test result criteria
#### Test pass criteria
The user verifies the current helper-address configuration status on the specified interface is reflected in show command.
#### Test fail criteria
The user verifies the current helper-address configuration status on the specified interface is not reflected in show command.