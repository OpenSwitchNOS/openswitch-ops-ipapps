...
- [Verify the dhcp-relay configuration](#verify-the-dhcp-relay-configuration)
    ...
    - [Verify DHCP relay option 82 with drop policy configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-with-drop-policy-configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 with replace policy configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-with-replace-policy-configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 with keep policy configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-with-keep-policy-configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 with keep policy and IP remote ID configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-with-keep-policy-and-ip-remote-id-configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 with drop policy and IP remote ID configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-with-drop-policy-and-ip-remote-id-configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 with replace policy and IP remote ID configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-with-replace-policy-and-ip-remote-id-configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 with drop policy and validation configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-with-drop-policy-and-validation-configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 with replace policy and validation configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-with-replace-policy-and-validation-configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 drop policy with validation and IP remote ID configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-drop-policy-with-validation-and_ip_remote_id_configuration-status-in-show-running-configuration)
    - [Verify DHCP relay option 82 replace policy with validation and IP remote ID configuration configuration status in show running-configuration](#verify-dhcp-relay-option-82-replace-policy-with-validation-and_ip_remote_id_configuration-status-in-show-running-configuration)
