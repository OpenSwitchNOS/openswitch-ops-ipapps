...
- [Verify dhcp-relay option 82 configuration](#verify-dhcp-relay-option-82-configuration)
    ...
    - [Disable dhcp-relay option 82 keep policy](#disable-dhcp-relay-option-82-with-keep-policy)
    - [Enable dhcp-relay option 82 with replace policy](#enable-dhcp-relay-option-82-with-replace-policy)
    - [Disable dhcp-relay option 82 with replace policy](#disable-dhcp-relay-option-82-with-replace-policy)
...
### Test result criteria
#### Test pass criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is one.
#### Test fail criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is not one.

### Disable dhcp-relay option 82 with drop policy
### Description
Disable dhcp-relay option 82 with drop policy on dut01 using the `no dhcp-relay option 82 drop` command.
### Test result criteria
#### Test pass criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is not one.
#### Test fail criteria
...
### Test result criteria
#### Test pass criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is zero.
#### Test fail criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is not zero.

### Disable dhcp-relay option 82 with keep policy
### Description
Disable dhcp-relay option 82 with keep policy on dut01 using the `no dhcp-relay option 82 keep` command.
### Test result criteria
#### Test pass criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is not zero.
#### Test fail criteria
...
### Test result criteria
#### Test pass criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is two.
#### Test fail criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is not two.

### Disable dhcp-relay option 82 with replace policy
### Description
Disable dhcp-relay option 82 with replace policy on dut01 using the `dhcp-relay option 82 replace` command.
### Test result criteria
#### Test pass criteria
Verify that the DHCP relay option 82 policy state in the unixctl dump output is not two.
#### Test fail criteria
