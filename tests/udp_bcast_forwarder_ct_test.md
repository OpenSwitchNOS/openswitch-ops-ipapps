...
### Description
Verify the UDP broadcast forwarding status using the show command `show ip forward-protocol`.
### Test result criteria
#### Test pass criteria
...
### Description
Verify the maximum (16) UDP forward-protocol configurations per interface.
### Test result criteria
#### Test pass criteria
The user is able to configure a maximum of 16 UDP forward-protocol configurations.
#### Test fail criteria
The user is unable to configure a maximum of 16 UDP forward-protocol configurations.
